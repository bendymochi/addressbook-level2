...
== Sorting all persons by name and display as a list : `sort`

Shows a list of all persons sorted alphabetically, along with their non-private details, in the address book. +
Format: `sort`
